<x-manager-layout>
    <x-post-editor>
        ...
        <div class="mb-4">
            <h1 class="font-semibold text-2xl text-center">{{ __('Bejegyzés módosítása') }}</h1>
        </div>
        ...
        <form method="POST" action="/post/{{ $post->id }}" enctype="multipart/form-data">
            ...
            <div class="flex flex-wrap justify-between">
                ...
                <div class="mt-4">
                    ...
                    <x-input id="position" class="block mt-1" type="number" name="position" :value="old('position', $post->position)" min="1" max="{{ $max }}" required />
                </div>
            ...
            <input type="hidden" name="section_id" value="{{ $post->section_id }}"/>
