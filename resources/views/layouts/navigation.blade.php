                ...
                @foreach($menuItems as $menuItem)
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="center" width="32">
                            <x-slot name="trigger">
                                <button class="flex items-center text-sm font-medium text-gray-500 px-1 pt-1 h-16 border-b-2 border-transparent leading-5 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
